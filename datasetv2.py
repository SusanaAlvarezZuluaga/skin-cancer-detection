...
class SkinCancerDataset(Dataset):
    def __init__(self, img_anotations, img_dir, transform=None, target_transform=None): #run once when instantiating the Dataset object.
    ...
    def __getitem__(self, idx):
        img_path = os.path.join(self.img_dir, self.img_labels.iloc[idx]["image_id"]) + '.jpg' #get images to path
